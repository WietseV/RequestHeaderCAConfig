 ...
 */
package com.requestHeaderConfig.core.models;
...
import com.requestHeaderConfig.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "requestHeaderConfig/components/helloworld");
